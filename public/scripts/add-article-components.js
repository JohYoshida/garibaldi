...
function insertHeader() {
  $("<section></section>")
    .insertBefore(".article-submit")
    .append(
      "<button class='remove-component' type='button'>Remove Header</button>"
    )
...
function insertParagraph() {
  $("<section></section>")
    .insertBefore(".article-submit")
    .append(
      "<button class='remove-component' type='button'>Remove Paragraph</button>"
    )
